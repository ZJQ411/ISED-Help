...
![priceMatrix.png](priceMatrix.png)
...
![MinMaxLoadGTEC.png](MinMaxLoadGTEC.png)
...
![outagesOverview.png](outagesOverview.png)
![outagesDef.png](outagesDef.png)
...
![EVEditor_Vehicle.png](EVEditor_Vehicle.png)
![evStationLayout.png](evStationLayout.png)
![evStationTopology.png](evStationTopology.png)
...
![HeatPumpEfficiency.png](HeatPumpEfficiency.png)
![HtP-CarnotEfficiency.png](HtP-CarnotEfficiency.png)
...
![ThermalValveInTopology.png](ThermalValveInTopology.png)
...
氢能设备用于氢气的生产、储存、运输和使用。

### 电解槽 (Electrolyzer)

![Electrolyzer-Replacement.png](Electrolyzer-Replacement.png)
...
![hydrogenHBT.png](hydrogenHBT.png)
...
![ProcessPlant.png](ProcessPlant.png)
![HeatBalanceTable_AmmoniaPlant.png](HeatBalanceTable_AmmoniaPlant.png)
